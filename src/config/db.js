...
async function getAllProducts() {
  if (isMongoConnected) {
    ...
    return docs.map(doc => {
      ...
      return {
        ...
        fragranceFamily: doc.fragranceFamily || doc.family || '',
  ...
  return local.map(p => {
    ...
    return {
      ...p,
      fragranceFamily: p.fragranceFamily || p.family || '',
      notes: p.notes || '',
      mood: p.mood || '',
      occasion: p.occasion || '',
...
async function createProduct(productData) {
  ...
  const newProduct = {
    ...
    fragranceFamily: productData.fragranceFamily ? productData.fragranceFamily.trim() : (productData.family ? productData.family.trim() : ''),
    ...
    occasion: productData.occasion ? productData.occasion.trim() : '',
